# Checklist de publicação — Socializando LP v4

- [ ] Inserir número final do WhatsApp em `script.js`
- [ ] Testar CTA principal do hero
- [ ] Testar CTA final
- [ ] Testar botão flutuante do WhatsApp
- [ ] Conferir o logo no topo, hero, CTA e rodapé
